    ...
    <div class="x_panel">
      ...
      <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" enctype="multipart/form-data" method="POST" action="{{ route('productimage.store') }}">
        @csrf
          ...
          <div class="item form-group">
            <label class="col-form-label col-md-3 col-sm-3 label-align" >Image Title
            </label>
            <div class="col-md-6 col-sm-6 ">
              <input type="text" id="img_title" name="img_title" required="required" class="form-control " placeholder="Image Title ...">
            </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
              <input type="file" class="custom-file-input" id="img" name="img" style="opacity:1">
